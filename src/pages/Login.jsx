...
function Login({ history }) {
  ...
  return (
    <div className={ `login-container ${dark}` }>
      <svg height="250" viewBox="0 0 64 64" width="250" xmlns="http://www.w3.org/2000/svg">
        <g id="package-delivery-food-restaurant">
          <path d="m14 17h36v44h-36z" fill="#5bcbfa" />
          <circle cx="32" cy="39" fill="#ffda44" r="18" />
          <path d="m61 46v4h-2-9v-4h8z" fill="#c0ab91" />
          <path d="m59 28-2 11h-1-6v-11z" fill="#957856" />
          <path d="m61 24v4h-2-9v-4h8z" fill="#c0ab91" />
          <path d="m56 17 2 7h-8v-7z" fill="#ebe5dd" />
          <path d="m56 39 2 7h-8v-7z" fill="#e9e9ea" />
          <g fill="#957856">
            <path d="m59 50-2 11h-7v-11z" />
            <path d="m14 50v11h-7l-2-11z" />
            <path d="m14 28v11h-6-1l-2-11z" />
          </g>
          <path d="m14 39v7h-8l2-7z" fill="#e9e9ea" />
          <path d="m14 17v7h-8l2-7z" fill="#ebe5dd" />
          <path d="m14 46v4h-9-2v-4h3z" fill="#c0ab91" />
          <path d="m14 24v4h-9-2v-4h3z" fill="#c0ab91" />
          <path
          ...
          <path
            ...
            fill="#e9e9ea"
          />
          <path d="m41 42-6-2v-4a6 6 0 0 1 6-6z" fill="#fff" />
          <path d="m28 30v4h-1v-4h-2v4h-1v-4h-2v6a4 4 0 0 0 8 0v-6z" fill="#fff" />
        </g>
      </svg>
      <Form.Control
